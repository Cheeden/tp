...
import static tutortrack.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static tutortrack.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static tutortrack.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY + validExpectedPersonString,
