...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_SELF_CONTACT = "+651234";
    private static final String INVALID_NOK_CONTACT = "123abc";
    ...
    private static final String VALID_SELF_CONTACT = BENSON.getSelfContact().toString();
    ...
    private static final List<JsonAdaptedLessonPlan>
            VALID_LESSONPLANS = BENSON.getLessonPlanList().stream().map(JsonAdaptedLessonPlan::new)
                                        .collect(Collectors.toList());
    private static final List<JsonAdaptedLessonProgress>
            VALID_LESSONPROGRESSES = BENSON.getLessonProgressList().stream().map(JsonAdaptedLessonProgress::new)
                                             .collect(Collectors.toList());
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_SELF_CONTACT, VALID_NOK_CONTACT,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_SELF_CONTACT, VALID_NOK_CONTACT,
                VALID_SUBJECTLEVEL, VALID_DAYTIME, VALID_COST, VALID_ADDRESS, VALID_TAGS,
                VALID_LESSONPLANS, VALID_LESSONPROGRESSES);
    ...
    @Test
    public void toModelType_invalidSelfContact_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_SELF_CONTACT, VALID_NOK_CONTACT,
                        VALID_SUBJECTLEVEL, VALID_DAYTIME, VALID_COST, VALID_ADDRESS, VALID_TAGS,
                        VALID_LESSONPLANS, VALID_LESSONPROGRESSES);
    ...
    public void toModelType_nullSubjectLevel_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_SELF_CONTACT, VALID_NOK_CONTACT,
                        null, VALID_DAYTIME, VALID_COST, VALID_ADDRESS, VALID_TAGS,
                        VALID_LESSONPLANS, VALID_LESSONPROGRESSES);
    ...
    public void toModelType_nullDayTime_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_SELF_CONTACT, VALID_NOK_CONTACT,
                        VALID_SUBJECTLEVEL, null, VALID_COST, VALID_ADDRESS, VALID_TAGS,
                        VALID_LESSONPLANS, VALID_LESSONPROGRESSES);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_SELF_CONTACT, VALID_NOK_CONTACT,
                VALID_SUBJECTLEVEL, VALID_DAYTIME, VALID_COST, null, VALID_TAGS,
                VALID_LESSONPLANS, VALID_LESSONPROGRESSES);
