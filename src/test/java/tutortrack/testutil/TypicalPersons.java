...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
                                                ...
                                                .withSubjectLevel("P4-Math").withDayTime("Monday 1200")
                                                .withHourlyRate("$50")
                                                .withTags("friends")
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
                                                ...
                                                .withSubjectLevel("P5-Math").withDayTime("Monday 1300")
                                                .withHourlyRate("$60")
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz")
                                              ...
                                              .withHourlyRate("$40").withAddress("wall street")
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier")
                                                ...
                                                .withHourlyRate("$70").withAddress("10th street").withTags("friends")
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer")
                                              ...
                                              .withHourlyRate("$55").withAddress("michegan ave")
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz")
                                               ...
                                               .withHourlyRate("$60").withAddress("little tokyo")
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best")
                                                ...
                                                .withSubjectLevel("P1-Math").withDayTime("Monday 1800")
                                                .withHourlyRate("$40")
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier")
                                              ...
                                              .withSubjectLevel("P2-Math").withDayTime("Monday 1000")
                                              .withHourlyRate("$50")
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller")
                                             ...
                                             .withHourlyRate("$50").withAddress("chicago ave")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY)
                                             ...
                                             .withHourlyRate(VALID_HOURLYRATE_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB)
                                             ...
                                             .withHourlyRate(VALID_HOURLYRATE_BOB).withAddress(VALID_ADDRESS_BOB)
