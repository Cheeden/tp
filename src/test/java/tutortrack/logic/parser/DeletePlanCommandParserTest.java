...
public class DeletePlanCommandParserTest {
    ...
    public void parse_validInput_returnsDeletePlanCommand() {
        ...
        DeletePlanCommand expectedCommand = new DeletePlanCommand(INDEX_FIRST_PERSON, LocalDate.of(2025, 10, 15));
    ...
    public void parse_invalidIndex_throwsParseException() {
        ...
        assertParseFailure(parser, args, String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeletePlanCommand.MESSAGE_USAGE));
    }
