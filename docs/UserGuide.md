...
3. Copy the file to the folder you want to use as the _home folder_ for your TutorTrack. Make sure the tutortrack.jar file is the only file in the folder.
