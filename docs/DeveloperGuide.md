...
* The current diagram shows the higher level details only, lower level details `JsonAdaptedLessonItem`, `JsonAdaptedLessonPlan`, `JsonAdaptedLessonProgress` are not included. 
