...
public class StringUtil {
    ...
    /**
     * Returns true if any word in the {@code sentence} starts with the {@code prefix}.
     *   Ignores case, prefix match is performed on word boundaries.
     *   <br>examples:<pre>
     *       containsPrefixIgnoreCase("ABc def", "ab") == true
     *       containsPrefixIgnoreCase("ABc def", "DE") == true
     *       containsPrefixIgnoreCase("ABc def", "c d") == false //not a single word prefix
     *       containsPrefixIgnoreCase("ABc def", "bc") == false //not a prefix of any word
     *       </pre>
     * @param sentence cannot be null
    ...
    public static boolean containsPrefixIgnoreCase(String sentence, String prefix) {
        ...
        return Arrays.stream(wordsInPreppedSentence)
                .anyMatch(word -> word.toLowerCase().startsWith(preppedPrefix.toLowerCase()));
    }
